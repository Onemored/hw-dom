...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createBoard: () => (/* binding */ createBoard),\n/* harmony export */   createGoblin: () => (/* binding */ createGoblin),\n/* harmony export */   moveGoblin: () => (/* binding */ moveGoblin),\n/* harmony export */   placeGoblin: () => (/* binding */ placeGoblin),\n/* harmony export */   startGame: () => (/* binding */ startGame),\n/* harmony export */   stopGame: () => (/* binding */ stopGame)\n/* harmony export */ });\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _goblin_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goblin.png */ \"./src/goblin.png\");\n\n\nvar intervalId = null;\nfunction createBoard() {\n  var board = document.getElementById('game-board');\n  if (!board) {\n    throw new Error('Элемент #game-board не найден в DOM');\n  }\n  board.textContent = '';\n  var cells = [];\n  for (var i = 0; i < 16; i++) {\n    var cell = document.createElement('div');\n    cell.classList.add('cell');\n    board.appendChild(cell);\n    cells.push(cell);\n  }\n  return cells;\n}\nfunction createGoblin() {\n  var goblin = document.createElement('img');\n  goblin.src = _goblin_png__WEBPACK_IMPORTED_MODULE_1__[\"default\"];\n  goblin.classList.add('goblin');\n  goblin.alt = 'Гоблин';\n  return goblin;\n}\nfunction placeGoblin(cells, goblin) {\n  var currentPosition = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -1;\n  var pos = currentPosition;\n  if (pos === -1) {\n    pos = Math.floor(Math.random() * 16);\n  }\n  cells[pos].append(goblin);\n  return pos;\n}\nfunction moveGoblin(cells, goblin, currentPosition) {\n  var newPosition;\n  do {\n    newPosition = Math.floor(Math.random() * 16);\n  } while (newPosition === currentPosition);\n  cells[newPosition].append(goblin);\n  return newPosition;\n}\nfunction stopGame() {\n  if (intervalId !== null) {\n    clearInterval(intervalId);\n    intervalId = null;\n  }\n}\nfunction startGame() {\n  stopGame();\n  var cells = createBoard();\n  var goblin = createGoblin();\n  var currentPosition = placeGoblin(cells, goblin);\n  intervalId = setInterval(function () {\n    currentPosition = moveGoblin(cells, goblin, currentPosition);\n  }, 1000);\n  return intervalId;\n}\n\n//# sourceURL=webpack://hw-dom/./src/index.js?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + \"images/goblin.png\");\n\n//# sourceURL=webpack://hw-dom/./src/goblin.png?\n}");
